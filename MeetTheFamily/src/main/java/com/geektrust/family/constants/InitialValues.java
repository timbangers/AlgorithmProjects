...
public class InitialValues {
	public static String initialValues = "ADD_ROOT Margaret Female\r\n" + 
			"ADD_SPOUSE Margaret Arthur Male\r\n" + 
			"ADD_CHILD Margaret Bill Male\r\n" + 
			"ADD_SPOUSE Bill Flora Female\r\n" + 
			"ADD_CHILD Margaret Charlie Male\r\n" + 
			"ADD_CHILD Margaret Percy Male\r\n" + 
			"ADD_SPOUSE Percy Audrey Female\r\n" + 
			"ADD_CHILD Margaret Ronald Male\r\n" + 
			"ADD_SPOUSE Ronald Helen Female\r\n" + 
			"ADD_CHILD Margaret Ginerva Female\r\n" + 
			"ADD_SPOUSE Ginerva Harry Male\r\n" + 
			"ADD_CHILD Flora Victoire Female\r\n" + 
			"ADD_CHILD Flora Dominique Female\r\n" + 
			"ADD_CHILD Flora Louis Male\r\n" + 
			"ADD_SPOUSE Victoire Ted Male\r\n" + 
			"ADD_CHILD Victoire Remus Male\r\n" + 
			"ADD_CHILD Audrey Molly Female\r\n" + 
			"ADD_CHILD Audrey Lucy Female\r\n" + 
			"ADD_CHILD Helen Rose Female\r\n" + 
			"ADD_SPOUSE Rose Malfoy Male\r\n" + 
			"ADD_CHILD Helen Hugo Male\r\n" + 
			"ADD_CHILD Rose Draco Male\r\n" + 
			"ADD_CHILD Rose Aster Female\r\n" + 
			"ADD_CHILD Ginerva James Male\r\n" + 
			"ADD_SPOUSE James Darcy Female\r\n" + 
			"ADD_CHILD Darcy William Male\r\n" + 
			"ADD_CHILD Ginerva Albus Male\r\n" + 
			"ADD_SPOUSE Albus Alice Female\r\n" + 
